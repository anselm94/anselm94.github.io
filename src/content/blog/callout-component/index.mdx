...
| <span class="flex items-center gap-2 border-indigo-500 dark:bg-indigo-950/10 text-indigo-700 dark:text-indigo-400 px-2 py-1 border-l-4"><Icon name="lucide:check-circle" /> Theorem</span> | For important mathematical or logical statements that have been proven |
| <span class="flex items-center gap-2 border-indigo-400 dark:bg-indigo-950/10 text-indigo-600 dark:text-indigo-300 px-2 py-1 border-l-4"><Icon name="lucide:puzzle" /> Lemma</span> | For helper theorems used in proving larger results |
| <span class="flex items-center gap-2 border-indigo-300 dark:bg-indigo-950/10 text-indigo-500 dark:text-indigo-200 px-2 py-1 border-l-4"><Icon name="lucide:git-branch" /> Corollary</span> | For results that follow directly from theorems |
| <span class="flex items-center gap-2 border-indigo-300 dark:bg-indigo-950/10 text-indigo-500 dark:text-indigo-200 px-2 py-1 border-l-4"><Icon name="lucide:file-text" /> Proposition</span> | For important statements that are less significant than theorems |
| <span class="flex items-center gap-2 border-fuchsia-500 dark:bg-fuchsia-950/10 text-fuchsia-700 dark:text-fuchsia-300 px-2 py-1 border-l-4"><Icon name="lucide:help-circle" /> Conjecture</span> | For unproven statements believed to be true |
